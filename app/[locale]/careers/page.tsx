...
import { ApplicationForm, type ApplicationFormHandle } from "@/components/ApplicationForm";
...
const VALUES = [
  {
    icon: Rocket,
    title: "Move Fast",
    description: "We ship weekly. Decisions beat meetings.",
  },
  {
    icon: Lightbulb,
    title: "Think Sharp",
    description: "Numbers before opinions. Specifics before slogans.",
  },
  {
    icon: Handshake,
    title: "Grow Together",
    description: "Client wins are team wins. No credit theatre.",
  },
];
